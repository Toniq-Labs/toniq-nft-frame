...
import {toniqNftTagName} from '../toniq-nft-tag-name';
...
import {defaultToniqNtState} from './toniq-nft-state';

export const ToniqNft = defineElement<NftConfig>()({
    tagName: toniqNftTagName,
    ...
    renderCallback({state, inputs, updateState, host, dispatch, events}) {
        ...
        const error: Error | undefined =
            state.childIframeLoading instanceof Error ? state.childIframeLoading : undefined;
